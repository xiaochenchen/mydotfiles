...
# put usr/local/bin before /usr/bin as recommended by brew
export PATH=/usr/local/bin:~/bin:$PATH
export PATH=$PATH:$HOME/.rvm/bin # Add RVM to PATH for scripting

# 3.2) Configure JAVA_HOME
# Set JAVA_HOME, Apple recommened to set to /usr/libexec/java_home
export JAVA_HOME=$(/usr/libexec/java_home)

# 3.3) Configure GRADLE_HOME
export GRADLE_HOME=/usr/local/Cellar/gradle/1.6

## ----------------------------------
## -- 3) Source customized bashrc  --
## ----------------------------------

## Define any user-specific variables you want here.
source ~/.bashrc_custom

# source bashrc for grc
